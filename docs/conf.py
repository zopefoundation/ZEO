#
# ZEO documentation build configuration file, created by sphinx-quickstart on
# Thu Oct 18 00:16:24 2012.
#
...
latex_documents = [
    ('index', 'ZEO.tex', 'ZEO Documentation',
...
man_pages = [
    ('index', 'btrees', 'ZEO Documentation',
...
texinfo_documents = [
    ('index',
     ...
     'ZEO',
     'Single-server client-server database server for ZODB',
     'Miscellaneous'),
]
